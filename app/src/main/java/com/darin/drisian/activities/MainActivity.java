...
import com.darin.drisian.BuildConfig;
import com.darin.drisian.R;
import com.darin.drisian.fragments.FavFragment;
import com.darin.drisian.fragments.HomeFragment;
import com.darin.drisian.fragments.WallpaperFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawer = new DrawerBuilder()
                ...
                .withAccountHeader(new AccountHeaderBuilder()
                        ...
                        .addProfiles(
                                new ProfileDrawerItem().withName(getString(R.string.app_name)).withEmail("Version " + BuildConfig.VERSION_NAME)
                        )
                        .build())
                .withSelectedItem(0)
                .addDrawerItems(
